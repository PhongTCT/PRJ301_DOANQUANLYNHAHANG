                ...
                <c:choose>
                    <c:when test="${showGoogleInfoForm or not empty sessionScope.pendingGoogleLogin}">
                        ...
                        <form action="MainController" method="POST">
                            ...
                            <div class="surface-soft p-3 mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="small muted">${pendingGoogle.email}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-brand w-100">Create account and continue</button>
                            <div class="text-center mt-3">
                                <a href="MainController?action=login&clearGoogleDraft=1" class="small muted">Use another login method</a>
                            </div>
                        </form>
                    </c:when>
                    <c:when test="${showFacebookInfoForm or not empty sessionScope.pendingFacebookLogin}">
                        ...
                        <form action="MainController" method="POST">
                            ...
                            <div class="surface-soft p-3 mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="small muted">${pendingFacebook.email}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-brand w-100">Create account and continue</button>
                            <div class="text-center mt-3">
                                <a href="MainController?action=login&clearFacebookDraft=1" class="small muted">Use another login method</a>
                            </div>
                        </form>
                    </c:when>
                    <c:otherwise>
