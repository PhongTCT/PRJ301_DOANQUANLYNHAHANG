...
<style>
    ...
    .invoice-summary__number{font-family:"Cormorant Garamond",Georgia,serif;font-size:2.4rem;line-height:1;font-weight:600;font-variant-numeric:tabular-nums}
    ...
    .invoice-amount{font-family:"Cormorant Garamond",Georgia,serif;font-size:1.5rem;line-height:1;font-weight:600;color:#191714}
