    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <form class="border rounded-3 p-4 bg-light" method="post" action="MainController">
                ...
                <label class="form-label">Name</label><input class="form-control mb-3" name="categoryName" value="${editCategory.categoryName}" required>
