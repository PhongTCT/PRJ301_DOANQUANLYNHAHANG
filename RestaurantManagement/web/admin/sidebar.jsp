...
<aside class="admin-sidebar">
    ...
    <c:if test="${sessionScope.currentUser.role == 'ADMIN'}">
        ...
        <a class="admin-sidebar__link ${param.active == 'menu-items' ? 'active' : ''}" href="${pageContext.request.contextPath}/MainController?action=adminMenuItems"><i class="fa-solid fa-utensils"></i><span><fmt:message key="admin.sidebar.menuitems"/></span></a>
